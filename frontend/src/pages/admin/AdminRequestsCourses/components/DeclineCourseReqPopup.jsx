...
import {ACoursesReqList, declineJoinRequest} from "../../../../api/adminsStore/adminStore";
export default function DeclineCourseReqPopup({handleClose,setHandleClose,request}) {
    const dispatch = useDispatch();
    const handleDecline = () => {
        dispatch(declineJoinRequest({courseID:request.courseId,studentId:request.studentId}));
