                    ...
                    <div className="dashElement">
                        <Link to="/admin/requests">
                            <div className="d-flex align-items-center justify-content-between p-3 h-100">
                                ...
                                <div className="dash-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-inbox-fill" viewBox="0 0 16 16">
                    ...
                    <div className="dashElement">
                        <Link to="/admin/teachers">
                            <div className="d-flex align-items-center justify-content-between p-3 h-100">
                                ...
                                <div className="dash-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-briefcase-fill" viewBox="0 0 16 16">
