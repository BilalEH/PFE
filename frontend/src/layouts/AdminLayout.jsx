                    ...
                    <div className="dashElement">
                        <Link to="/admin/requests">
                            <div className="d-flex align-items-center justify-content-between p-3 h-100">
                                ...
                                <div className="dash-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-inbox-fill" viewBox="0 0 16 16">
                    ...
                    <div className="dashElement">
                        <Link to="/admin/students">
                            <div className="d-flex align-items-center justify-content-between p-3 h-100">
                                ...
                                <div className="dash-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-backpack" viewBox="0 0 16 16">
                    ...
                    <div className="dashElement">
                        <Link to="/admin/messages">
                            <div className="d-flex align-items-center justify-content-between p-3 h-100">
                                ...
                                <div className="dash-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-chat-left-dots-fill" viewBox="0 0 16 16">
