                        ...
                        return (
                            <tr key={student.id}>
                                <td className="icons-td">
                                    ...
                                    <button className="table-btn update" onClick={() => handleUpdate(student.id)}>
                                        {updateIcone}
                                    </button>
                                </td>
                                <td>{student.user_id.cin}</td>
                                <td className="text-capitalize">{student.user_id.firstName}</td>
                                <td className="text-capitalize">{student.user_id.lastName}</td>
                                <td className="text-capitalize">{student.absparent_id.user_id.lastName} {student.absparent_id.user_id.firstName}</td>
                                <td>{student.dateN}</td>
