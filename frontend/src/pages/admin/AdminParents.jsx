...
<div>
    ...
    {
        parentsData.status === 'loading' ?<div className='w-100 text-center'><CircularProgress /></div>:parentsData.status === 'failed' ?<div><Alert severity="error">Error</Alert></div>:parentsData.parents.length === 0 ?<div><Alert severity="warning">pas des donnes</Alert></div>:(
                ...
                <tbody>
                    ...
                    <tr key={parent.id}>
                        <td className='icons-td'>
                            ...
                            <button className='table-btn update' onClick={()=> handleUpdate(parent.id)}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
